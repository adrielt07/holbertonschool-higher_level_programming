...
- 1-multi_languages.js - script that prints 3 lines:he first line: “C is fun”
...
- 2-arguments.js - prints a message depending of the number of arguments passed
  ...
  - You must use console.log(...) to print all output
  - You are not allowed to use var
- 3-value_argument.js - script that prints the first argument passed to it3-value_argument.js
  - If no arguments are passed to the script, print “No argument”
  - You must use console.log(...) to print all output
  - You are not allowed to use var
